...
<body>
    ...
    <div class="postEtMenu">
        ...
        <div class="cadreMenu" id="cadreMenu">
            ...
            <div class="bottomMenu">
                <div class="profileMenu" >
                    <a href="connexion.php"><img src="MenuCode/img/circle-user-round.svg" alt=""><p id="profile">Profile</p></a>
                </div>
        ...
        <div class="posts">
            <h1>Post récents de vos amis</h1>
                ...
                <div class="left-part">
                    <div class="div-top-user">  
                        <div class="user-infos">
                            <img id="user-pp" src="img/pfp.png">
                            <p id="user-name">Sully.rmd</p>
                        </div>
                        <p id="datetime">01/01/1970</p>
                    </div>

                    
                    <div id="photo-container">
                        <img src="img/soirée.jpg" class="photo" alt="Image">
                        <div class="posted-by">
                            <p>Posté par</p>
                            <div class="account-info">
                                <img id="account-pp" src="img/pfp.png" alt="Profile Picture">
                                <span id="account-name">Tibo</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="div-bottom">
                        <div class="div-vues">
                            <svg id="logo-vues" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M2.06202 12.3481C1.97868 12.1236 1.97868 11.8766 2.06202 11.6521C2.87372 9.68397 4.25153 8.00116 6.02079 6.81701C7.79004 5.63287 9.87106 5.00073 12 5.00073C14.129 5.00073 16.21 5.63287 17.9792 6.81701C19.7485 8.00116 21.1263 9.68397 21.938 11.6521C22.0214 11.8766 22.0214 12.1236 21.938 12.3481C21.1263 14.3163 19.7485 15.9991 17.9792 17.1832C16.21 18.3674 14.129 18.9995 12 18.9995C9.87106 18.9995 7.79004 18.3674 6.02079 17.1832C4.25153 15.9991 2.87372 14.3163 2.06202 12.3481Z" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <p id="nbr-vues">69</p>
                        ...
                        <div class="div-actions">
                            <svg id="repost-post" xmlns="http://www.w3.org/2000/svg" width="19" height="12" viewBox="0 0 19 12" fill="none">
                                <path d="M1 3.5L3.5 1L6 3.5" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M10.1667 11H5.16667C4.72464 11 4.30072 10.8244 3.98816 10.5118C3.67559 10.1993 3.5 9.77536 3.5 9.33333V1" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M17.6665 8.5L15.1665 11L12.6665 8.5" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8.5 1H13.5C13.942 1 14.366 1.17559 14.6785 1.48816C14.9911 1.80072 15.1667 2.22464 15.1667 2.66667V11" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <svg id="fav-post" xmlns="http://www.w3.org/2000/svg" width="14" height="17" viewBox="0 0 14 17" fill="none">
                                <path d="M12.6667 16L6.83333 12.6667L1 16V2.66667C1 2.22464 1.17559 1.80072 1.48816 1.48816C1.80072 1.17559 2.22464 1 2.66667 1H11C11.442 1 11.866 1.17559 12.1785 1.48816C12.4911 1.80072 12.6667 2.22464 12.6667 2.66667V16Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <svg id="like-post" xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none">
                                <path d="M2.31804 2.31804C1.90017 2.7359 1.5687 3.23198 1.34255 3.77795C1.1164 4.32392 1 4.90909 1 5.50004C1 6.09099 1.1164 6.67616 1.34255 7.22213C1.5687 7.7681 1.90017 8.26417 2.31804 8.68204L10 16.364L17.682 8.68204C18.526 7.83812 19.0001 6.69352 19.0001 5.50004C19.0001 4.30656 18.526 3.16196 17.682 2.31804C16.8381 1.47412 15.6935 1.00001 14.5 1.00001C13.3066 1.00001 12.162 1.47412 11.318 2.31804L10 3.63604L8.68204 2.31804C8.26417 1.90017 7.7681 1.5687 7.22213 1.34255C6.67616 1.1164 6.09099 1 5.50004 1C4.90909 1 4.32392 1.1164 3.77795 1.34255C3.23198 1.5687 2.7359 1.90017 2.31804 2.31804Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                    </div>
                </div>
                <a href="#" id="btn-voir"><p id="voir">Voir les commentaires</p></a>
                <div class="right-part">
                    <p id="titre">Soirée</p>
                    <div class="com" >
                        <div class="comment-container">
                            <input type="text" name="commentaire" id="comment" placeholder="Ceci est un commentaire">
                            <svg id="send" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-send-horizontal"><path d="M3.714 3.048a.498.498 0 0 0-.683.627l2.843 7.627a2 2 0 0 1 0 1.396l-2.842 7.627a.498.498 0 0 0 .682.627l18-8.5a.5.5 0 0 0 0-.904z"/><path d="M6 12h16"/></svg>
                        </div>
                    </div>
                </div>
            </div>
...
echo "ID_user : " . $_SESSION["id_users"]."<br>"."Pseudo : " . $_SESSION["username"]."<br>"."email : " . $_SESSION["email"]."<br>";
